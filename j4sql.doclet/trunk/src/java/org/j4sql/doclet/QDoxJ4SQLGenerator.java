...
public class QDoxJ4SQLGenerator extends AbstractQdoxTask {
	...
	public void execute() throws BuildException {
		...
		try {
			...
			dbPlatform.writeComment("Generated by J4SQL doclet task", pw);
			dbPlatform.writeComment("see: http://j4sql.codehaus.org/", pw);
			dbPlatform.writeComment(cal.toString(), pw);
			pw.write("\n\n");
			dbPlatform.writeComment("Deployment file for "
					+ dbPlatform.getName(), pw);
	...
	private void processMethod(JavaMethod method, JavaClass clazz,
		...
		dbPlatform.writeEntity(entity, pw);
	}
	...
	private Function processFunction(DocletTag fnDoc, JavaMethod method,
		...
		if (fnRet == null) {
			String type = method.getReturns().getJavaClass()
					.getFullyQualifiedName();
			fnRet = dbPlatform.getDefaultRDBMSType(type);
		}
