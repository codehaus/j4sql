...
public abstract class PostgreSQLPlatform extends StandardSQLPlatform {
	...
	static {
		...
		m_PgTypeMap.put("void", "void");
	}

	/*
	 * (non-Javadoc)
	 * 
	 * @see org.j4sql.common.DbPlatform#writeEntity(org.j4sql.common.Entity,
	 *      java.io.PrintWriter)
	 */
	public void writeEntity(Entity entity, PrintWriter out)
		...
		if (entity instanceof Trigger) {
			...
			if (entity instanceof Function) {
				...
				throw new NotSupportedException("Entity class not supported:"
						+ entity.getClass());
		} else {
			throw new NotSupportedException("Entity class not supported:"
					+ entity.getClass());
	...
	private void writeTrigger(Trigger trigger, PrintWriter out)
			throws NotSupportedException {
		...
		if (trigger.getScope() == Trigger.SCOPE_ROW)
			...
			out.print("STATEMENT");
		out.print(" EXECUTE PROCEDURE " + triggerFn.getSchema() + "."
				+ triggerFn.getName());
	}

	private void writeFunction(Function function, PrintWriter out)
			throws NotSupportedException {
		...
		while (i.hasNext()) {
			...
			case Parameter.PARAM_TYPE_IN:
				out.print(" in ");
				break;
			case Parameter.PARAM_TYPE_INOUT:
			case Parameter.PARAM_TYPE_OUT:
				throw new NotSupportedException(
						"IN and INOUT parameters are not supported by PostgreSQL");
			}
		...
		if (function.getSqlAccess() == Function.SQLACCESS_NO
	...
	public String getDefaultRDBMSType(String classname)
		...
		if (type == null)
			throw new NotSupportedException("Java type not supported: "
					+ classname);
		return type;
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.j4sql.common.DbPlatform#writeDeployJar(java.lang.String,
	 ...
	 * (non-Javadoc)
	 * 
	 * @see org.j4sql.common.DbPlatform#writeUndeployJar(java.lang.String,
	 *      java.io.PrintWriter)
	 */
